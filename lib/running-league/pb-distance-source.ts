...
export type PbDistanceSourceSpec = {
  ...
  /** 그래프 히스토리에 포함할 phase (측정 이력 슬롯) */
  historyRecordPhases: ReadonlyArray<'month_start' | 'month_end' | 'mid_month' | 'other'>
  /** 초 단위 정렬 필드 */
...
export const PB_DISTANCE_SOURCES: Record<PbLeaderboardDistance, PbDistanceSourceSpec> = {
  '5km': {
    ...
    distanceEvent: '5km',
    rankingRecordPhase: 'other',
    historyRecordPhases: ['month_start', 'month_end', 'mid_month', 'other'],
    secondsField: 'time_seconds',
  },
  '10km': {
