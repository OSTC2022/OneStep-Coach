...
assert.match(rankingsSource, /러닝 기록 추가/)
...
assert.match(rankingsSource, /order-1 min-w-0/)
assert.match(rankingsSource, /order-2 min-w-0/)
assert.match(rankingsSource, /overflow-x-hidden/)
assert.match(rankingsSource, /flex-wrap gap-2/)
